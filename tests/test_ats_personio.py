...
from ats_adapters import ats_personio as ap
...
<workzag-jobs>
  <position>
    ...
    <name>Working Student Software Engineering (m/f/d)</name>
...
def test_parse_xml_extracts_positions():
    ...
    assert len(jobs) == 2
    j = jobs[0]
    assert j["title"] == "Working Student Software Engineering (m/f/d)"
